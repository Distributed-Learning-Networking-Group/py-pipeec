"""
This file is derived from ByteScheduler project

The origional file can be found in:
https://github.com/bytedance/byteps/blob/bytescheduler/bytescheduler/bytescheduler/common/profiler.py

Full license can be found in:
https://github.com/bytedance/byteps/blob/bytescheduler/bytescheduler/LICENSE
